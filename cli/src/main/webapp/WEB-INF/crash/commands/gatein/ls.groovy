...
""")
  @Command
  public Object main(@Option(names = ["l", "list"]) Boolean list, @ContentTypeOption String contentType, @AttributeOption List<String> attributes, @PathArgument Path path) throws ScriptException
  {
    assertConnected()
